#include <stdio.h> 
 ...
 { 
     int i, num, isPrime; 
 /* isPrime is used as flag variable. If isPrime = 0, then number is composite else if  
         isPrime = 1, then number is prime. Initially I have assumed the number as prime.*/ 
     isPrime = 1;  
